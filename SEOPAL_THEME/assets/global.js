...
document.addEventListener('DOMContentLoaded', function() {
  const variantButtons = document.querySelectorAll('.variant-button input');
  ...
  variantButtons.forEach(button => {
    button.addEventListener('change', function() {
      ...
      // Update price in the payment box
      const paymentPriceElement = document.getElementById('payment-price');
      paymentPriceElement.innerHTML = Shopify.formatMoney(variantPrice);
    });
  });
